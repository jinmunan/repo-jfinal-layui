...
-- 视频教程
INSERT INTO sys_function VALUES ('video', '视频教程', 0, 'https://www.qinhaisenlin.com/video', 'frame', 'JFinal极速开发企业应用管理系统', 0, 'layui-icon-video', 10, NULL, 1, 0);
...
-- 视频教程
INSERT INTO sys_role_function VALUES ('admin-video', 'video', 'admin');
INSERT INTO sys_role_function VALUES ('superadmin_video', 'video', 'superadmin');
INSERT INTO sys_role_function VALUES ('sys_video', 'video', 'sys');
...
INSERT INTO sys_tree VALUES ('402880e87a1ca809017a1ca89dda0004', NULL, '自定义SQL表单', 'form', '2021-06-18 09:07:30', 1);
...
CREATE TABLE session  (
  ...
  user_code varchar(100) CHARACTER SET utf8mb4  NULL DEFAULT NULL COMMENT '用户编号',
  expiret_time bigint(20) NULL DEFAULT NULL COMMENT '过期时间',
  PRIMARY KEY (id) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8mb4  COMMENT = 'session' ROW_FORMAT = Dynamic;
